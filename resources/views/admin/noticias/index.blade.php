                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-cabecalho-tabela">
                                ...
                                <th class="px-5 py-3.5 font-semibold hidden text-left md:table-cell">Resumo</th>
                                <th class="px-5 py-3.5 font-semibold hidden text-left md:table-cell">Categoria</th>
                                <th class="px-5 py-3.5 font-semibold hidden text-left md:table-cell">Publicação</th>
